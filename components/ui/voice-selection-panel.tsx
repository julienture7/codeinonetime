...
import { AVAILABLE_VOICES, DEFAULT_VOICE_NAME } from '../../constants'; 
...
export const VoiceSelectionPanel: React.FC<VoiceSelectionPanelProps> = ({ selectedVoice, onVoiceChange }) => {
